...
SECRET_KEY = 'django-insecure-aq#**l4-yjf(t5s78f5@mj#9965vxtezjrz9%&+4n_4&x7#hx!'
...
DATABASES = {
    'default': {
        ...
        'USER': os.environ.get('DJANGO_DB_USER', 'banshee'),
        'PASSWORD': os.environ.get('DJANGO_DB_PASSWORD', 'banshee123'),
